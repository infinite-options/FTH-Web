      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "right", padding: "10px" }}>
            <ModalCloseBtn
              onClick={() => props.toggleAddFoodBank()}
          ...
          >
            <Modal.Title style={{ fontWeight: "bold" }}>Food Bank</Modal.Title>
            <Modal.Body>
              <div className={styles.modalContainerVertical}>
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Name</div>
                  <input
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Image</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Business Type</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Hours</div>
                  {/* <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Accepting Hours</div>
                  {/* <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Delivery Hours</div>
                  {/* <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Contact First Name</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Contact Last Name</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Phone Number</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Alt. Phone Number</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Email</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Website</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Facebook</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Instagram</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
                ...
                <div className={styles.modalContainerHorizontal}>
                  <div className={styles.modalFormLabel}>Twitter</div>
                  <input
                    className={styles.modalInput}
                    value={newItem.item_name}
                    onChange={(event) =>
