...
function CreateMenu({ history, ...props }) {
  ...
  const filterBusiness = (event) => {
    ...
    if (newBusinessID === "All Orders") {
      ...
      dispatch({
        type: "FETCH_HOURS",
        payload: JSON.parse(newBusinessData[0].business_accepting_hours)
      })
    }
    state.defaultFlag = false;
    // console.log(state.selectedBusinessID)
      ...
      <div className={styles.root}>
        ...
        <Container fluid className={styles.container}>
          ...
          <Row 
            ...
            style={{border: "solid", borderColor: "#E7404A", borderWidth: "2px"}}
